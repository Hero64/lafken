---
title: "@lafken/event"
description: "Listen and react to Amazon EventBridge events using TypeScript decorators. @lafken/event lets you define event rules with pattern-based filtering and automatically connects them to Lambda functions. Supports custom events, S3 notifications, and DynamoDB stream events."
---
