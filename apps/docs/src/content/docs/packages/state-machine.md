---
title: "@lafken/state-machine"
description: "Define AWS Step Functions state machines using TypeScript decorators. @lafken/state-machine lets you declare states, transitions, service integrations, and nested workflows directly within your classes — no raw JSON or ASL required."
---
